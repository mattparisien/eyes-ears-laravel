...
blocks:
            ...
            content:
              ...
              -
                ...
                content:
                  -
                    type: text
                    text: 'Hollywood Climate Summit will be closing with a yoga and movement session (3:00-4:00 pm PT) presented by Walkgood LA followed by Earth Sessions (4:00-7:00 pm PT), presented by Intersectional Environmentalist 501c3, an event that combines art, activism, climate optimism and environmental education in order to hold space and create accessible and joyful moments for people with intersecting identities to find community and learn about climate justice.'
            block_theme: light
            type: row
            enabled: true
  ...
  -
    ...
    version: feature_single_2
    title: About
    description: "The Hollywood Climate Summit (HCS) is an annual multi-day hybrid conference that creates a cross-sector community space for thousands of entertainment and media professionals to take action on climate. Our event gathers filmmakers, executives, artists, activists, climate organizations, scientists, and other experts to exchange ideas and inspire each other's work. The 4th summit will take place from June 21st-24th with an in-person conference in LA live streamed internationally. Sponsors include Netflix, Paramount Global, Meta, NBCUniversal, Good Energy, NRDC, The Redford Center, Earth Angel, Scriptation and many more!"
    block_theme: light
    image_frame: false
    toggle: false
    type: feature_single
